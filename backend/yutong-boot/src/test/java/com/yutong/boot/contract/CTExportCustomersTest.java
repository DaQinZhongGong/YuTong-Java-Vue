...
/**
 * CT-exportCustomers 契约测试。
 *
 * <p>设计来源: 58-后端API逐接口任务清单 (CT-exportCustomers 验收标准)
 * <p>契约来源: openapi.yaml GET /api/v1/customers/export
 *              (x-permission: biz:customer:export)
 *
 ...
 *   <li>CT-3 权限拒绝 (viewer 无 biz:customer:export, 403 AUTH-403001)</li>
 *   <li>CT-4 traceId 透传 (响应头 X-Trace-Id + 响应体 traceId)</li>
 * </ol>
 *
 * <p>权限矩阵: admin (*) 有权限; biz 用户有 biz:customer:export; viewer/approver 无。
 */
@DisplayName("CT-exportCustomers: GET /api/v1/customers/export 契约测试")
class CTExportCustomersTest extends AbstractContractTest {

    private static final String API_PATH = "/api/v1/customers/export";
    ...
    void testExportCustomersSuccess() throws Exception {
    ...
    void testExportCustomersUnauthenticated() {
    ...
    @Test
    @DisplayName("CT-3: 权限拒绝 (viewer 无 biz:customer:export, 403 AUTH-403001)")
    void testExportCustomersForbiddenViewer() throws Exception {
    ...
    void testExportCustomersTraceIdPropagation() throws Exception {
        MvcResult result = performGet(API_PATH, mockUser("biz"));
