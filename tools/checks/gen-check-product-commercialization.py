# -*- coding: utf-8 -*-
"""Generator for check-product-commercialization.ps1 (UTF-8 BOM for PS 5.1)."""
import os
...
out_path = os.path.join(ROOT, 'check-product-commercialization.ps1')
with open(out_path, 'wb') as f:
    f.write(b'\xef\xbb\xbf')
    f.write(PS1.encode('utf-8'))
